package xin.manong.hylian.server.dao.tools;
...
public class MybatisPlusGenerator {
    ...
    private final static String PARENT_PACKAGE = "xin.manong.hylian.server.dao";
