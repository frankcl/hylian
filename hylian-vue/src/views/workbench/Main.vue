...
import WorkbenchMenu from '@/views/workbench/Menu'
import WorkbenchNav from '@/views/workbench/Nav'
  ...
  <div id="main-wrapper" class="page-wrapper" data-layout="vertical"
    ...
    <aside class="left-sidebar">
      <div class="brand-logo align-items-center justify-content-between d-flex">
        ...
        <div class="ml-4 d-xl-none cursor-pointer" @click="hideSidebar">
          <IconX color="#5a6a85" size="20" />
        </div>
      </div>
      <workbench-menu />
    </aside>
    <div class="body-wrapper">
      <header class="app-header">
        <workbench-nav @show-sidebar="showSidebar" />
      </header>
