...
public class SecurityController {
    ...
    public void applyCode(@QueryParam("app_id")  String appId,
        ...
        httpResponse.sendRedirect(String.format("%s%s%s=%s", requestURL, hasQuery ? "&" : "?", PARAM_CODE, code));
    }
    ...
    public String getToken(@QueryParam("code")  String code,
        ...
        if (!loginAppService.isLoginApp(profile.id, appId)) {
            LoginApp loginApp = new LoginApp(profile.id, profile.userId, appId,
                    httpService.getRequestBaseURL(httpRequest));
    ...
    public String refreshToken(@RequestBody RefreshTokenRequest request,
        ...
        cookieService.setCookie(COOKIE_TICKET, newTicket, "/", httpRequest, httpResponse);
        return newToken;
    }
    ...
    public void logout(@Context HttpServletRequest httpRequest,
        ...
        cookieService.removeCookie(COOKIE_TICKET, "/", httpResponse);
    }
    ...
    public void login(@RequestBody LoginRequest request,
        ...
        cookieService.setCookie(COOKIE_TICKET, ticket, "/", httpRequest, httpResponse);
