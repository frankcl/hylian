/*
 ...
 Source Schema         : security_keeper

 Target Server Type    : MySQL
 Target Server Version : 80030 (8.0.30)
 File Encoding         : 65001

 Date: 03/11/2023 18:00:21
*/
...
CREATE TABLE `app_login` (
  ...
  `logout_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `create_time` bigint NOT NULL,
  `update_time` bigint NOT NULL,
  `ticket_id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `user_role` (
  ...
  KEY `INDEX_CREATE_TIME` (`create_time`) USING BTREE,
  KEY `INDEX_UPDATE_TIME` (`update_time`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1713802299421294596 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
