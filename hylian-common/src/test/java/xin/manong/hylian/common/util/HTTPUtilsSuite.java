 ...
 */
public class HTTPUtilsSuite {

    @Test
    public void testRemoveQueries() {
        {
            String url = "http://www.sina.com.cn/a/b/c?a=1&b=2&c=abc";
            Set<String> queryKeys = new HashSet<>();
            queryKeys.add("a");
            queryKeys.add("c");
            Assert.assertEquals("http://www.sina.com.cn/a/b/c?b=2", HTTPUtils.removeQueries(url, queryKeys));
        }
        {
            String url = "http://www.sina.com.cn:123/a/b/c?a=1&b=2&c=abc";
            Set<String> queryKeys = new HashSet<>();
            queryKeys.add("a");
            Assert.assertEquals("http://www.sina.com.cn:123/a/b/c?b=2&c=abc", HTTPUtils.removeQueries(url, queryKeys));
        }
        {
