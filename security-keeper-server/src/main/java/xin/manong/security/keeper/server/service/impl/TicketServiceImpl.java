...
import xin.manong.security.keeper.server.service.TicketService;
...
public class TicketServiceImpl implements TicketService {
    ...
    @Override
    public void removeTicketTokens(String ticketId) {
        String key = String.format("%s%s", Constants.TICKET_TOKEN_PREFIX, ticketId);
        RSet<String> tokens = redisClient.getRedissonClient().getSet(key);
        tokens.delete();
    }
    ...
    @Override
    public Set<String> getTicketTokens(String ticketId) {
        String key = String.format("%s%s", Constants.TICKET_TOKEN_PREFIX, ticketId);
        RSet<String> tokens = redisClient.getRedissonClient().getSet(key);
