...
public class Constants {
    ...
    public static final String SERVER_PATH_GET_USERS = "api/security/getUsers";
    public static final String SERVER_PATH_BATCH_GET_USERS = "api/security/batchGetUsers";
    public static final String SERVER_PATH_GET_USER_BY_ID = "api/security/getUserById";
